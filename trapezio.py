...
################################################CONSTRUINDO A INTERFACE################################################
    ...
    layout = [
        ...
        [sg.Text('Digite o extremo inferior do intervalo de integração:')],
        [sg.Input(key='-a-', do_not_clear=True,size=(10,1))],
        [sg.Text('Digite o extremo superior do intervalo de integração:')],
        [sg.Input(key='-b-', do_not_clear=True,size=(10,1))],
        [sg.Text('Digite o número, n, de trapézios (n-1 pontos):')],
    ...
    while event != 'Voltar':
        ...
        if event == 'Tutorial':
            print('____________________________________________TUTORIAL_____________________________________________\n'
                  'Por exemplo, para aplicar a regra do trapézio com n = 2 (2 trapézios ou 3 pontos) a função '
                  'f(x) = exp(x) de no intervalo [0,1], digite exp(x) na primeira entrada, 0 na segunda, 1 na '
